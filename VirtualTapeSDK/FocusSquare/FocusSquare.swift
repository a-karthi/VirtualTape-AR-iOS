...
public class FocusSquare: SCNNode {
    ...
    static let pointerRadiuses: (min: CGFloat, max: CGFloat) = (0.005, 0.01)
    ...
    public lazy var pointer: SphereNode = {
        let pointer = SphereNode()
        pointer.sphereGeometry.radius = FocusSquare.pointerRadiuses.max
        return pointer
    }()
